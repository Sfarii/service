...
/**
 * Class InterestsDatatable
 *
 * @package ServiceBundle\Datatables
 */
class InterestsDatatable extends AbstractDatatable
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->columnBuilder
              ->add(null, MultiselectColumn::class, array(
                ...
                'actions' => array(
                    array(
                        'route' => 'interests_bulk_delete',
                        'icon' => 'uk-icon-trash',
                        'label' => $this->translator->trans('action.delete'),
                        'attributes' => array(
                            'rel' => 'tooltip',
                            'title' => 'Delete',
                            'class' => 'sg-datatables-interests_datatable-multiselect-action md-btn md-btn-primary md-btn-wave-light md-btn-icon waves-effect waves-button waves-light',
                            'role' => 'button'
                        ),
          ...
          ->add('imageName', ImageColumn::class, array(
              'title' => $this->translator->trans('interests.field.image'),
              'class_name' => 'uk-table-middle',
              'imagine_filter' => 'thumbnail_50_x_50',
              'imagine_filter_enlarged' => 'thumbnail_250_x_250',
              'relative_path' => '/images/intrest',
              ))
            ->add('title', Column::class, array(
                'title' => $this->translator->trans('interests.field.title'),
                'class_name' => 'uk-table-middle',
                ))
