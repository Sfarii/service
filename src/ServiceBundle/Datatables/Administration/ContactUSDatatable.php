 ...
 */
class ContactUSDatatable extends AbstractDatatable
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->columnBuilder
              ->add(null, MultiselectColumn::class, array(
                ...
                'actions' => array(
                    array(
                        'route' => 'contactus_bulk_delete',
                        'icon' => 'uk-icon-trash',
                        'label' => $this->translator->trans('action.delete'),
                        'attributes' => array(
                            'rel' => 'tooltip',
                            'title' => 'Delete',
                            'class' => 'sg-datatables-contactus_datatable-multiselect-action md-btn md-btn-primary md-btn-wave-light md-btn-icon waves-effect waves-button waves-light',
                            'role' => 'button'
                        ),
            ...
            ->add('name', Column::class, array(
                'title' => $this->translator->trans('contactus.field.name'),
                'class_name' => 'uk-table-middle',
                ))
            ->add('email', Column::class, array(
                'title' => $this->translator->trans('contactus.field.email'),
                'class_name' => 'uk-table-middle',
                ))
            ->add('message', Column::class, array(
                'title' => $this->translator->trans('contactus.field.message'),
                'class_name' => 'uk-table-middle',
                ))
